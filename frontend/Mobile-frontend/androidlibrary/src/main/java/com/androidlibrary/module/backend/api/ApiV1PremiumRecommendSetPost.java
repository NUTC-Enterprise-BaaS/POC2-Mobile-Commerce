 ...
 */
public class ApiV1PremiumRecommendSetPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {
    private ApiParams apiParams;

    public ApiV1PremiumRecommendSetPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1PremiumRecommendSet(apiParams);
    }
