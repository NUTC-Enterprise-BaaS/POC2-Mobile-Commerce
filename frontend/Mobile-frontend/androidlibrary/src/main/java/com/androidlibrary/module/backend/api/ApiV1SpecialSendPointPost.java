 ...
 */
public class ApiV1SpecialSendPointPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {

    public ApiV1SpecialSendPointPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1SpecialPointSend(getParams());
    }
