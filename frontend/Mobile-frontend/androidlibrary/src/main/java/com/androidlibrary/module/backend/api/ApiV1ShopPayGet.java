 ...
 */
public class ApiV1ShopPayGet<T extends ProcessingData> extends AuthTokenGetRequest<T> {
    public ApiV1ShopPayGet(Context context, ApiParams params) {
        super(context, params);
    }

    @Override
    protected String getUrl() {
        return ApiUrls.apiV1ShopPay(getParams());
    }
}
