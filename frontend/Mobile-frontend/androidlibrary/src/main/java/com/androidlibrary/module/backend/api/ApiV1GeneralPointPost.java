 ...
 */
public class ApiV1GeneralPointPost<T extends ProcessingData> extends PostRequest<T> {
    private ApiParams apiParams;

    public ApiV1GeneralPointPost(Context context, ApiParams params) {
        super(context);
    ...
    protected String getUrl() {
        return ApiUrls.apiV1Point(apiParams);
    }
