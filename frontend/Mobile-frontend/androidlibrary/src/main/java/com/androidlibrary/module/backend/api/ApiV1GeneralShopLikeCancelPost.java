 ...
 */
public class ApiV1GeneralShopLikeCancelPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {

    public ApiV1GeneralShopLikeCancelPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1GeneralShopLikeCancel(getParams());
    }
