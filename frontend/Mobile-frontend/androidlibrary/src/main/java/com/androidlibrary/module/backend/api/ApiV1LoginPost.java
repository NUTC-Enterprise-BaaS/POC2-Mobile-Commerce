 ...
 */
public class ApiV1LoginPost<T extends ProcessingData> extends PostRequest<T> {
    private ApiParams apiParams;

    public ApiV1LoginPost(Context context, ApiParams params) {
        super(context);
    ...
    protected String getUrl() {
        return ApiUrls.apiV1Login(apiParams);
    }
    ...
    protected Map<String, String> getPostParams() {
        ...
        params.put(ParamsConst.Key.ACCOUNT, apiParams.inputEmail);
        params.put(ParamsConst.Key.PASSWORD, apiParams.inputPassword);
        return params;
    }
}
