 ...
 */
public class ApiV1SpecialRecommendSetPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {
    private ApiParams apiParams;

    public ApiV1SpecialRecommendSetPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1SpecialRecommendSet(apiParams);
    }
