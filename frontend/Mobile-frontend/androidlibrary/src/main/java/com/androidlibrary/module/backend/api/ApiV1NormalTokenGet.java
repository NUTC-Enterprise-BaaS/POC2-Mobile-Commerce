...
public class ApiV1NormalTokenGet<T extends ProcessingData> extends AuthTokenGetRequest<T> {
    public ApiV1NormalTokenGet(Context context, ApiParams params) {
        super(context, params);
    }

    @Override
    protected String getUrl() {
        return ApiUrls.apiV1Token(getParams());
    }
}