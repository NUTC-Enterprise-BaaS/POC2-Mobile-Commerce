 ...
 */
public class ApiV1GeneralSendPointPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {

    public ApiV1GeneralSendPointPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1SendPoint(getParams());
    }
    ...
    protected Map<String, String> getPostParams() {
        ...
        params.put(ParamsConst.Key.POINT, getParams().inputPoint);
        params.put(ParamsConst.Key.SEND_PHONE_NUMBER, getParams().inputPhone);
