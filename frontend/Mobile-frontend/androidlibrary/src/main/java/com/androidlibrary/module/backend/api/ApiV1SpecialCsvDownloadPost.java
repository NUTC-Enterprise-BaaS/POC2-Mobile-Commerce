 ...
 */
public class ApiV1SpecialCsvDownloadPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {

    public ApiV1SpecialCsvDownloadPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1SpecialCsvDownload(getParams());
    }
