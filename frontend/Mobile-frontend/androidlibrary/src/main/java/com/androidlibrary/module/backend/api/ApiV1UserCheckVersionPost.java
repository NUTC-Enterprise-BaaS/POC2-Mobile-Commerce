 ...
 */
public class ApiV1UserCheckVersionPost<T extends ProcessingData> extends PostRequest<T> {
    private ApiParams params;
    public ApiV1UserCheckVersionPost(Context context,ApiParams params) {
        super(context);
        this.params = params;
    }
    ...
    protected String getUrl() {
        return ApiUrls.apiV1UserCheckVersion(params);
    }
    ...
    protected Map<String, String> getPostParams() {
        ...
        params.put(ParamsConst.Key.VERSION, ApiV1UserCheckVersionPost.this.params.inputVersion);
        return params;
    }
}
