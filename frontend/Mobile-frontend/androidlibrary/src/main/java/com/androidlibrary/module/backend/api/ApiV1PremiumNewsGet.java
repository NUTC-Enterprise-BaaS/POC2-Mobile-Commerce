 ...
 */
public class ApiV1PremiumNewsGet<T extends ProcessingData> extends AuthTokenGetRequest<T> {

    public ApiV1PremiumNewsGet(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        ...
        return ApiUrls.apiV1PremiumNews(getParams()) + paramsGet;
    }
