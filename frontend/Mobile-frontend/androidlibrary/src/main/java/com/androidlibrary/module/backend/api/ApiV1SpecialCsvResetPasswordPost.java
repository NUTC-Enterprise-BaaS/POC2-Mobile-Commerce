 ...
 */
public class ApiV1SpecialCsvResetPasswordPost <T extends ProcessingData> extends AuthTokenPostRequest<T> {
    public ApiV1SpecialCsvResetPasswordPost(Context context, ApiParams params) {
        super(context, params);
    }

    @Override
    protected String getUrl() {
        return ApiUrls.apiV1UserSpecialCsvResetPassword(getParams());
    }
