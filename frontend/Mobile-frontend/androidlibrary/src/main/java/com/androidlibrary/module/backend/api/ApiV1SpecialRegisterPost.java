 ...
 */
public class ApiV1SpecialRegisterPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {
    public ApiV1SpecialRegisterPost(Context context, ApiParams params) {
        super(context, params);
    }

    @Override
    protected String getUrl() {
        return ApiUrls.apiV1SpecialRegister(getParams());
    }
