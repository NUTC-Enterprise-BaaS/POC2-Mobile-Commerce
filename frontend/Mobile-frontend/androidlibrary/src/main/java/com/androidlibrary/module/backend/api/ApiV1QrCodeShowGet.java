 ...
 */
public class ApiV1QrCodeShowGet<T extends ProcessingData> extends AuthTokenGetRequest<T> {
    public ApiV1QrCodeShowGet(Context context, ApiParams params) {
        super(context, params);
    }

    @Override
    protected String getUrl() {
        return ApiUrls.apiV1QrCodeShow(getParams());
    }
}
