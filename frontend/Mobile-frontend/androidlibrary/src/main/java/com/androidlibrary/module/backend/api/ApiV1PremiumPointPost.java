 ...
 */
public class ApiV1PremiumPointPost<T extends ProcessingData> extends PostRequest<T> {
    private ApiParams apiParams;

    public ApiV1PremiumPointPost(Context context, ApiParams params) {
        super(context);
    ...
    protected String getUrl() {
        return ApiUrls.apiV1PreferentialPoint(apiParams);
    }
