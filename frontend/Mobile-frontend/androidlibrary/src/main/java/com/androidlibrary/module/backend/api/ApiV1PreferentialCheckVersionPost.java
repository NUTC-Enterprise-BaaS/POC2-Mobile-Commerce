 ...
 */
public class ApiV1PreferentialCheckVersionPost<T extends ProcessingData> extends PostRequest<T> {
    private ApiParams params;
    public ApiV1PreferentialCheckVersionPost(Context context, ApiParams params) {
        super(context);
        this.params = params;
    }
    ...
    protected String getUrl() {
        return ApiUrls.apiV1PreferentialCheckVersion(params);
    }
    ...
    protected Map<String, String> getPostParams() {
        ...
        params.put(ParamsConst.Key.VERSION, ApiV1PreferentialCheckVersionPost.this.params.inputVersion);
        return params;
    }
}
