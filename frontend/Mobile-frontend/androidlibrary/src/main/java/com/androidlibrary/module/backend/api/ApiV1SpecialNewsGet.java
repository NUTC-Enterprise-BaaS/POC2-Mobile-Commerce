...
public class ApiV1SpecialNewsGet<T extends ProcessingData> extends AuthTokenGetRequest<T> {

    public ApiV1SpecialNewsGet(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        ...
        return ApiUrls.apiV1SpecialNews(getParams()) + paramsGet;
    }
