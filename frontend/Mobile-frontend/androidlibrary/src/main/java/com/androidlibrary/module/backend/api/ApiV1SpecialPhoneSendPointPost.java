 ...
 */
public class ApiV1SpecialPhoneSendPointPost<T extends ProcessingData> extends AuthTokenPostRequest<T> {

    public ApiV1SpecialPhoneSendPointPost(Context context, ApiParams params) {
    ...
    protected String getUrl() {
        return ApiUrls.apiV1SpecialPhonePointSend(getParams());
    }
