package com.poc2.contrube.controllor.register;
...
import com.androidlibrary.module.backend.api.ApiV1PreferentialRegisterPost;
...
import com.poc2.contrube.model.BitmapCompression;
...
public class PremiumRegisterController {
    private final String TAG = PremiumRegisterController.class.getName();
    ...
    private PremiumRegisterController.CallBackEvent mCallBackEvent;
    ...
    public PremiumRegisterController(Context context) {
    ...
    public void registerRequest(String name, int type, String address, String contact, int sex, String job) {
        ...
        loadingDialog.show();
        WebRequest<ApiV1PreferentialRegisterPostData> request = new ApiV1PreferentialRegisterPost<>(context, apiParams);
        request.processing(new WebRequest.Processing<ApiV1PreferentialRegisterPostData>() {
            @Override
            public ApiV1PreferentialRegisterPostData run(String data) {
                return new ApiV1PreferentialRegisterPostData(data);
            }
        }).failProcess(new WebRequest.FailProcess<ApiV1PreferentialRegisterPostData>() {
            @Override
            public void run(String data, ApiV1PreferentialRegisterPostData information) {
        ...
        }).successProcess(new WebRequest.SuccessProcess<ApiV1PreferentialRegisterPostData>() {
            @Override
            public void run(String data, ApiV1PreferentialRegisterPostData information) {
                loadingDialog.dismiss();
    ...
    public void setmCallBackEvent(PremiumRegisterController.CallBackEvent callBackEvent) {
    ...
    public interface CallBackEvent {
        ...
        void onSuccess(ApiV1PreferentialRegisterPostData information);
    }
