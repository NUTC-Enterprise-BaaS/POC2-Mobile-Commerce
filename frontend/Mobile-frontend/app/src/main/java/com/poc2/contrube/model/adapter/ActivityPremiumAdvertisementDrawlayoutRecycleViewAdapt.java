...
public class ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt extends RecyclerView.Adapter<ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt.ViewHolder> {
    ...
    public ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt(Context context, ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt.DataStructure data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder = new ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt.ViewHolder(view);
    ...
    public void setItemClickListener(ActivityPremiumAdvertisementDrawlayoutRecycleViewAdapt.itemClickListener itemClickListener) {
    ...
    public static class DataStructure {
        ...
        public DataStructure() {
            ...
            iconGroup.add(R.drawable.icon_21);
            iconGroup.add(R.drawable.icon_22);
            iconGroup.add(R.drawable.icon_23);
            iconGroup.add(R.drawable.icon_24);
            iconGroup.add(R.drawable.icon_25);
            iconGroup.add(R.drawable.icon_26);
            iconGroup.add(R.drawable.icon_27);
            iconGroup.add(R.drawable.icon_28);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setBackgroundColor(int count) {
            if (count % 2 == 1) {
                content.setBackgroundColor(0x33C30D23);
            } else {
