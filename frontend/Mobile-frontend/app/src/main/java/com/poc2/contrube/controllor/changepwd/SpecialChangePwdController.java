package com.poc2.contrube.controllor.changepwd;
...
public class SpecialChangePwdController {
    ...
    public SpecialChangePwdController(Context context) {
    ...
    public void setmCallBackEvent(NormalChangePwdController.CallBackEvent callBackEvent) {
