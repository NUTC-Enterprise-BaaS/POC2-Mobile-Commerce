...
public class PremiumSettingController {
    private final String TAG = PremiumSettingController.class.getName();
    ...
    private PremiumSettingController.CallBackEvent mCallBackEvent;

    public PremiumSettingController(Context context) {
    ...
    public void setmCallBackEvent(PremiumSettingController.CallBackEvent callBackEvent) {
