...
public class SpecialRegisterRecommendController {
    private final String TAG = SpecialRegisterRecommendController.class.getName();
    private Context context;
    private AccountInjection accountInjection;
    private ServerInfoInjection serverInfoInjection;
    private ApiParams apiParams;
    private LoadingDialog loadingDialog;
    private SpecialRegisterRecommendController.CallBackEvent mCallBackEvent;

    public SpecialRegisterRecommendController(Context context) {
    ...
    public void setmCallBackEvent(SpecialRegisterRecommendController.CallBackEvent callBackEvent) {
