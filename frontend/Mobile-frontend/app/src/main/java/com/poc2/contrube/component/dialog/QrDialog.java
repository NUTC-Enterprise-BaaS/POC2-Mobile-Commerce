...
public class QrDialog extends Dialog {
    ...
    protected TextView tittleTextView() {
        ...
        v.setId(GenerateViewId.get());
        v.setLayoutParams(params);
        v.setText(getContext().getString(com.androidlibrary.R.string.qr_success_already_send_to_store) + "\n" + getContext().getString(com.androidlibrary.R.string.qr_success_please_contract_in_store));
    ...
    protected TextView contextTextView(View topView) {
        ...
        v.setId(GenerateViewId.get());
        v.setLayoutParams(params);
        v.setText(com.androidlibrary.R.string.qr_success_please_input_phone_number);
    ...
    protected Button submitButton(View topView) {
        ...
        v.setId(GenerateViewId.get());
        v.setLayoutParams(params);
        v.setText(com.androidlibrary.R.string.qr_success_check);
