...
public class PremiumActivityAdapt extends RecyclerView.Adapter<PremiumActivityAdapt.MyHolder> {
    private LayoutInflater layoutInflater;
    private Context context;
    private DataStructure data;
    private View.OnClickListener clickEvent;

    public PremiumActivityAdapt(Context context) {
        super();
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        holder.container.setTag(data.urlGroup.get(position));
