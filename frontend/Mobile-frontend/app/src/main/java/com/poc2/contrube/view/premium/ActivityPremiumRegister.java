...
import com.androidlibrary.module.backend.data.ApiV1PreferentialRegisterPostData;
import com.androidlibrary.module.backend.params.AccountInjection;
import com.androidlibrary.ui.basicinformation.data.ApiV1UserDetailGetData;
import com.poc2.R;
import com.poc2.contrube.component.dialog.UploadContentDialog;
import com.poc2.contrube.component.dialog.UploadLogoDialog;
import com.poc2.contrube.controllor.register.PremiumRegisterController;
...
public class ActivityPremiumRegister extends Activity {
    ...
    private PremiumRegisterController controller;
    ...
    private void init() {
        ...
        generateRandom(4);
        controller = new PremiumRegisterController(mContext);
    ...
    private void uploadContentDialog() {
        ...
        uploadContentDialog.setDialogTitle(R.string.premium_upload_content_dialog_title);
        uploadContentDialog.setDialogPrompt(R.string.premium_upload_content_dialog_prompt);
        uploadContentDialog.setDialogTitleColor(R.color.ColorPremiumTheme);
        uploadContentDialog.setButtonColor(R.drawable.premium_circle_button);
    ...
    private void uploadLogoDialog() {
        ...
        uploadLogoDialog.setDialogTitle(R.string.premium_upload_logo_dialog_title);
        uploadLogoDialog.setDialogPrompt(R.string.premium_upload_logo_dialog_prompt);
        uploadLogoDialog.setDialogTitleColor(R.color.ColorPremiumTheme);
        uploadLogoDialog.setButtonColor(R.drawable.premium_circle_button);
    ...
    private UploadContentDialog.UploadContentDialogClick contentDialogClick = new UploadContentDialog.UploadContentDialogClick() {
        ...
        public void onView1Click() {
            if (contentDialogCheck.size() > 0) {
                ...
                intent.setClass(ActivityPremiumRegister.this, ActivityPremiumSelectPicSingle.class);
                startActivityForResult(intent, SELECT_PIC_SINGLE_ONE);
            } else {
                Intent intent = new Intent();
                intent.setClass(ActivityPremiumRegister.this, ActivityPremiumSelectPicAll.class);
    ...
    private UploadLogoDialog.UploadLogoDialogClick logoDialogClick = new UploadLogoDialog.UploadLogoDialogClick() {
        ...
        public void onSubmitClick() {
            if (logoDialogCheck.size() > 0) {
                ...
                Log.e("uriPath", Uri.parse(logoUriPath.get(0)).getPath());
                Log.e("uristr", Uri.parse(logoUriPath.get(0)).toString());
            }
        ...
        public void onLogoClick() {
            Intent intent = new Intent();
            intent.setClass(ActivityPremiumRegister.this, ActivityPremiumSelectLogo.class);
    ...
    private View.OnClickListener subLogoSelectEvent = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (logoUriPath.size() <= 0) {
                String selectFail = ActivityPremiumRegister.this.getString(R.string.request_select_logo_fail);
                Toast.makeText(ActivityPremiumRegister.this, selectFail, Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private PremiumRegisterController.CallBackEvent callBackEvent = new PremiumRegisterController.CallBackEvent() {
        @Override
        public void onError() {
        ...
        @Override
        public void onSuccess(ApiV1PreferentialRegisterPostData information) {
            if (information.result == 0) {
    ...
    private View.OnClickListener scanClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent();
            intent.setClass(ActivityPremiumRegister.this, ActivityPremiumRegisterRecommend.class);
