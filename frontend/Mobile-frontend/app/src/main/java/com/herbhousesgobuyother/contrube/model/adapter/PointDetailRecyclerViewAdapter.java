...
/**
 * FragmentSpecialPoint RecyclerView Adapter
 * Created by flowmaHuang on 2016/11/8.
 */

public class PointDetailRecyclerViewAdapter extends RecyclerView.Adapter<PointDetailRecyclerViewAdapter.ViewHolder> {
    private LayoutInflater layoutInflater;
    private DataStructure data;
    private ViewHolder viewHolder;
    private View.OnClickListener editEvent;

    public PointDetailRecyclerViewAdapter(Context context) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_point_detail, parent, false);
