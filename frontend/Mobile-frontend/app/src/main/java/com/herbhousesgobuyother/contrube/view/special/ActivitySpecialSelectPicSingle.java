...
import com.herbhousesgobuyother.contrube.model.adapter.SelectPicSingleAdapt;

import java.util.ArrayList;

public class ActivitySpecialSelectPicSingle extends Activity {
    ...
    private SelectPicSingleAdapt selectPicAdapt;
    ...
    private void init() {
        ...
        selectPicAdapt = new SelectPicSingleAdapt(context);
