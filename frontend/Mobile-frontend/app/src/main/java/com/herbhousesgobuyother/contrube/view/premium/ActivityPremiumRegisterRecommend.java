...
import com.herbhousesgobuyother.contrube.controllor.recommend.PremiumRegisterRecommendController;
 ...
 */
public class ActivityPremiumRegisterRecommend extends AppCompatActivity {
    ...
    private PremiumRegisterRecommendController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_premium_register_recommend);
        findView();
        initSystemFont();
        init();
    }
    ...
    private void init() {
        ...
        itemId = "";
        phone = "";
        controller = new PremiumRegisterRecommendController(mContext);
    ...
    private PremiumRegisterRecommendController.CallBackEvent callBackEvent = new PremiumRegisterRecommendController.CallBackEvent() {
        @Override
        public void onError() {
