...
import com.herbhousesgobuyother.contrube.controllor.qrshow.FragmentSpecialQrcodeControllor;

import java.io.UnsupportedEncodingException;

/**
 * Created by 5*N on 2016/11/11.
 */

public class FragmentSpecialQrcode extends Fragment {
    public NetworkImageView qrcodeImageView;
    public Button sendQrcodeButton;
    public Button storeAlbumButton;

    private ImageLoader imageLoader;
    private FragmentSpecialQrcodeControllor controllor;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_special_qrcode, container, false);
    }
    ...
    private void init() {
        controllor = new FragmentSpecialQrcodeControllor(getContext());
    ...
    private FragmentSpecialQrcodeControllor.CallBackEvent callBack = new FragmentSpecialQrcodeControllor.CallBackEvent() {

        @Override
        public void onSuccess(ApiV1SpecialQrCodeShowGetData information) {
    ...
    private void findView() {
        qrcodeImageView = (NetworkImageView) getView().findViewById(R.id.special_qrcode_qr_image);
