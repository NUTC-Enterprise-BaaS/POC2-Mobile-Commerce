...
public class PremiumPointEditDialog extends AlertDialog.Builder {
    ...
    private SpecialPointEditDialog.EditDialogEvent clickEvent;

    public PremiumPointEditDialog(Context context) {
        super(context);
    ...
    public void setEditDialogEvent(SpecialPointEditDialog.EditDialogEvent clickEvent) {
