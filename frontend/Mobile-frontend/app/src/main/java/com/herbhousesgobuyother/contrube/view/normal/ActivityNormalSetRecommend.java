...
import com.herbhousesgobuyother.contrube.controllor.recommend.NormalSetRecommendController;
 ...
 */
public class ActivityNormalSetRecommend extends AppCompatActivity {
    ...
    private NormalSetRecommendController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_set_recommend);
        findView();
        initSystemFont();
        init();
    }
    ...
    private void init() {
        ...
        itemId = "";
        phone = "";
        controller = new NormalSetRecommendController(mContext);
    ...
    private NormalSetRecommendController.CallBackEvent callBackEvent = new NormalSetRecommendController.CallBackEvent() {
        @Override
        public void onError() {
            Toast.makeText(mContext, "QR CODE 錯誤，請換一張", Toast.LENGTH_LONG).show();
            finish();
        ...
        @Override
        public void onSuccess(ApiV1GeneralRecommendSetData information) {
