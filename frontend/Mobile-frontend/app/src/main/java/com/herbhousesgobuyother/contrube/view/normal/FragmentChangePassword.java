...
public class FragmentChangePassword extends Fragment {
    ...
    private NormalChangePwdController controller;
    ...
    private void init() {
        ...
        newPwd = "";
        pwdCheck = "";
        controller = new NormalChangePwdController(getContext());
    ...
    private NormalChangePwdController.CallBackEvent callBackEvent = new NormalChangePwdController.CallBackEvent() {
        ...
        public void onSuccess(ApiV1UserResetPasswordData information) {
            if (information.result == 0) {
                ...
                ((ActivityNormalAdvertisement) getActivity()).getAccountInjection().clear();
                getActivity().finish();
