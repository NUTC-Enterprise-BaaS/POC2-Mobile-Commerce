...
import com.herbhousesgobuyother.contrube.controllor.setting.PremiumSettingController;
...
public class FragmentPremiumSetting extends Fragment {
    ...
    private PremiumSettingController controller;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_premium_setting, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        controller = new PremiumSettingController(getContext());
    ...
    private View.OnClickListener changePwdClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            FragmentLauncher.changeToBack(getContext(), R.id.content_container, null, FragmentPremiumPasswordChoice.class.getName());
        }
    };
    ...
    private View.OnClickListener basicClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            FragmentLauncher.changeToBack(getContext(), R.id.content_container, null, FragmentPremiumBasicInformation.class.getName());
        }
    };
    ...
    private PremiumSettingController.CallBackEvent callBackEvent = new PremiumSettingController.CallBackEvent() {
        @Override
        public void onError() {
