...
import com.herbhousesgobuyother.contrube.controllor.recommend.SpecialSetRecommendController;
 ...
 */
public class ActivitySpecialSetRecommend extends AppCompatActivity {
    ...
    private SpecialSetRecommendController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_set_recommend);
        findView();
        initSystemFont();
        init();
    }
    ...
    private void init() {
        ...
        itemId = "";
        phone = "";
        controller = new SpecialSetRecommendController(mContext);
    ...
    private SpecialSetRecommendController.CallBackEvent callBackEvent = new SpecialSetRecommendController.CallBackEvent() {
        @Override
        public void onError() {
            Toast.makeText(mContext, "QR CODE 錯誤，請換一張", Toast.LENGTH_LONG).show();
            finish();
        ...
        @Override
        public void onSuccess(ApiV1SpecialRecommendSetData information) {
