...
public class SpecialSettingController {
    private final String TAG = SpecialSettingController.class.getName();
    ...
    private SpecialSettingController.CallBackEvent mCallBackEvent;

    public SpecialSettingController(Context context) {
    ...
    public void setmCallBackEvent(SpecialSettingController.CallBackEvent callBackEvent) {
