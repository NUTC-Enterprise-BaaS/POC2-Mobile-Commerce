...
import com.herbhousesgobuyother.contrube.component.dialog.FragmentSpecialPhoneSendDialog;
import com.herbhousesgobuyother.contrube.controllor.phone.FragmentSpecialPhoneSendControllor;
...
public class FragmentSpecialPhoneSend extends Fragment {
    ...
    private FragmentSpecialPhoneSendControllor controllor;
    ...
    private FragmentSpecialPhoneSendDialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_special_phone_send, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        controllor = new FragmentSpecialPhoneSendControllor(getContext());
        dialog = new FragmentSpecialPhoneSendDialog(getContext());
    ...
    private FragmentSpecialPhoneSendControllor.SendPointSuccess sendPointSuccess = new FragmentSpecialPhoneSendControllor.SendPointSuccess() {
        @Override
    ...
    private FragmentSpecialPhoneSendDialog.DialogClickEvent dialogClick = new FragmentSpecialPhoneSendDialog.DialogClickEvent() {
        @Override
        public void cancel() {
            alertDialog.dismiss();
        }
    ...
    private FragmentSpecialPhoneSendControllor.CallBackEvent callback = new FragmentSpecialPhoneSendControllor.CallBackEvent() {
        @Override
        public void onSuccess() {
