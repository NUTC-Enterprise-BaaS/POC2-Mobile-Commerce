...
public class PremiumRegisterRecommendController {
    private final String TAG = PremiumRegisterRecommendController.class.getName();
    private Context context;
    private AccountInjection accountInjection;
    private ServerInfoInjection serverInfoInjection;
    private ApiParams apiParams;
    private LoadingDialog loadingDialog;
    private PremiumRegisterRecommendController.CallBackEvent mCallBackEvent;

    public PremiumRegisterRecommendController(Context context) {
    ...
    public void setmCallBackEvent(PremiumRegisterRecommendController.CallBackEvent callBackEvent) {
