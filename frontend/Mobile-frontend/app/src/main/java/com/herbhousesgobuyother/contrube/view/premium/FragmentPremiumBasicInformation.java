...
import com.herbhousesgobuyother.contrube.controllor.basic.PremiumBasicController;
...
public class FragmentPremiumBasicInformation extends Fragment {
    ...
    private PremiumBasicController controller;
    private FinishModifyDialog finishModifyDialog;
    private View back;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_premium_basic_information, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        controller = new PremiumBasicController(getContext());
    ...
    private View.OnClickListener recommendClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ActivityLauncher.go(getContext(), ActivityPremiumSetRecommend.class, null);
        }
    };
    ...
    private PremiumBasicController.CallBackEvent callBackEvent = new PremiumBasicController.CallBackEvent() {
        @Override
        public void onError() {
        ...
        @Override
        public void onSuccess(ApiV1PremiumUserDetailGetData information) {
