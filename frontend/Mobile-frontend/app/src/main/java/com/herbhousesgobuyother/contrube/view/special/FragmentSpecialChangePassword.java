...
import com.herbhousesgobuyother.contrube.controllor.changepwd.SpecialChangePwdController;
...
public class FragmentSpecialChangePassword extends Fragment {
    private EditText nowPwdEdit;
    private EditText newPwdEdit;
    private EditText newPwdCheckEdit;
    private Button clickreloginButton;
    private SpecialChangePwdController controller;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_special_change_password, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        newPwd = "";
        pwdCheck = "";
        controller = new SpecialChangePwdController(getContext());
