...
import com.herbhousesgobuyother.contrube.controllor.csvchangepasssword.PremiumCsvChangePwdController;
...
public class FragmentPremiumCsvChangePassword extends Fragment {
    private EditText nowPwdEdit;
    private EditText newPwdEdit;
    private EditText newPwdCheckEdit;
    private Button clickreloginButton;
    private PremiumCsvChangePwdController controller;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_premium_csv_change_password, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        newPwd = "";
        pwdCheck = "";
        controller = new PremiumCsvChangePwdController(getContext());
    ...
    private PremiumCsvChangePwdController.CallBackEvent callBackEvent = new PremiumCsvChangePwdController.CallBackEvent() {
        @Override
        public void onError() {
        ...
        @Override
        public void onSuccess(ApiV1PreferentialCsvResetPasswordPostData information) {
