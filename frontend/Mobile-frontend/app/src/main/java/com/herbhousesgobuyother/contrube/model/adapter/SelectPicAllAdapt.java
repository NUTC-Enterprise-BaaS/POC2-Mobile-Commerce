...
public class SelectPicAllAdapt extends RecyclerView.Adapter<SelectPicAllAdapt.MyHolder> {
    ...
    public SelectPicAllAdapt(Context context) {
        super();
            ...
            public void onClick(View view) {
                if (mItemSelect.contains(imageKey)) {
                    ...
                    if (mItemSelect.size() < 3) {
                        ...
                        Toast.makeText(context, "最多選三張", Toast.LENGTH_LONG).show();
                    }
                }
