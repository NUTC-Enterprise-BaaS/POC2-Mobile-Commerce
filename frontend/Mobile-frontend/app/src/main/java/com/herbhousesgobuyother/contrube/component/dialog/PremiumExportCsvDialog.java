...
public class PremiumExportCsvDialog extends AlertDialog.Builder {
    ...
    public PremiumExportCsvDialog(Context context) {
        super(context);
        this.context = context;
        view = LayoutInflater.from(context).inflate(R.layout.dialog_premium_export_csv_password, null);
        this.setView(view);
    ...
    public void setCsvEvent(SpecialExportCsvDialog.CsvEvent event) {
        this.csvEvent = event;
    }
