...
import com.herbhousesgobuyother.contrube.controllor.csvchangepasssword.SpecialCsvChangePwdController;
...
public class FragmentSpecialCsvChangePassword extends Fragment {
    private EditText nowPwdEdit;
    private EditText newPwdEdit;
    private EditText newPwdCheckEdit;
    private Button clickreloginButton;
    private SpecialCsvChangePwdController controller;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_special_csv_change_password, container, false);
        return layout;
    }
    ...
    private void init() {
        ...
        newPwd = "";
        pwdCheck = "";
        controller = new SpecialCsvChangePwdController(getContext());
        clickreloginButton.setOnClickListener(restartClick);
        controller.setmCallBackEvent(callBackEvent);
        back.setOnClickListener(backClick);
    }

    private SpecialCsvChangePwdController.CallBackEvent callBackEvent = new SpecialCsvChangePwdController.CallBackEvent() {
        @Override
        public void onError() {
        ...
        @Override
        public void onSuccess(ApiV1SpecialCsvResetPasswordPostData information) {
            if (information.result == 0) {
                ...
                ((ActivitySpecialAdvertisement) getActivity()).getAccountInjection().clear();
                getActivity().finish();
