...
import com.herbhousesgobuyother.contrube.controllor.recommend.NormalRegisterRecommendController;
 ...
 */
public class ActivityNormalRegisterRecommend extends AppCompatActivity {
    ...
    private NormalRegisterRecommendController controller;
    ...
    private void init() {
        ...
        itemId = "";
        phone = "";
        controller = new NormalRegisterRecommendController(mContext);
    ...
    private NormalRegisterRecommendController.CallBackEvent callBackEvent = new NormalRegisterRecommendController.CallBackEvent() {
        @Override
        public void onError() {
