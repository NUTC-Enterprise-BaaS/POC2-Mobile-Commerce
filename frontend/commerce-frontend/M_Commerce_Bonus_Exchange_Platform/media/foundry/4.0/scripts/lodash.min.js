...
!freeGlobal||freeGlobal.global!==freeGlobal&&freeGlobal.window!==freeGlobal||(root=freeGlobal);var _=$._=runInContext();$.each(_,function(prop,func){Object.hasOwnProperty.call(_,prop)&&!/VERSION/.test(name)&&($[prop]||($[prop]=func))})});