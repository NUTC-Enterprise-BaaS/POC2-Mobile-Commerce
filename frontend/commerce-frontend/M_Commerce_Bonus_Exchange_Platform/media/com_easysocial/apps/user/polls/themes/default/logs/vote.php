...
<?php } else { ?>
	<?php echo $this->html('html.user', $actor->id); ?> <i class="fa fa-caret-right"></i> <?php echo $this->html('html.user', $target->id);?>
<?php } ?>

<div class="es-stream-preview">
	<div class="mt-10">
		<div class="stream-preview-title">
			<a target="_blank" href="<?php echo $assets->get( 'link' );?>"><i class="fa fa-link"></i> <?php echo $assets->get( 'title' ); ?></a>
