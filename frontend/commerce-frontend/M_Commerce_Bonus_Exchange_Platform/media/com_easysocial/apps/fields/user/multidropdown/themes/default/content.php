...
<div class="data-field-multitextbox" data-field-multidropdown data-max="<?php echo $params->get('max'); ?>">
	...
	<a href="javascript:void(0);" data-field-multidropdown-add <?php if (!(empty($limit) || $count < ($limit - 1))) { ?>style="display: none;"<?php } ?>><?php echo JText::_($params->get('add_button_text')); ?></a>
</div>
