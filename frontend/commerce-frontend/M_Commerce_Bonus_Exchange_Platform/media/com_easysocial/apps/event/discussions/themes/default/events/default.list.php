        ...
        <div class="media">
            ...
            <div class="media-body">
                ...
                <ul class="fd-reset-list discussion-meta">
                    ...
                    <li>
                        <?php echo JText::sprintf('APP_EVENT_DISCUSSIONS_STARTED_BY_ON', $this->html('html.user', $discussion->author->id), FD::date($discussion->created)->format(JText::_('DATE_FORMAT_LC1'))); ?>
                    </li>
                    <?php } ?>

                    <?php if ($params->get('display_last_replied', true) && $discussion->lastreply) { ?>
                    <li>
                        <?php echo JText::sprintf('APP_EVENT_DISCUSSIONS_LAST_REPLIED_BY', $this->html('html.user', $discussion->lastreply->author->id)); ?>
                    </li>
                    <?php } ?>
                </ul>
            </div>
...
<div class="empty empty-hero">
    ...
    <?php echo JText::_('APP_EVENT_DISCUSSIONS_EMPTY'); ?>
</div>

<div class="es-pagination center">
