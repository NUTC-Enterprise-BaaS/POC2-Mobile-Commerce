...
<div class="row mb-10 mt-10">
    <div class="col-xs-12">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <div class="discussion-meta fd-small">
                    <i class="fa fa-calendar"></i>&nbsp; <?php echo JText::sprintf('APP_EVENT_DISCUSSIONS_CONTENT_REPLIED_ON_META', FD::date($reply->created)->format(JText::_('DATE_FORMAT_LC1'))); ?>
                </div>
            </div>
        </div>
        ...
        <div class="mt-5">
            <a href="<?php echo $permalink; ?>"><?php echo JText::_('APP_EVENT_DISCUSSIONS_VIEW_DISCUSSION'); ?> &rarr;</a>
        </div>
    </div>
</div>
