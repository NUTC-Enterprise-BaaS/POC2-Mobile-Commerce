...
<div class="app-news" data-event-news data-id="<?php echo $event->id; ?>">
    ...
    <div class="es-filterbar row-table">
        <div class="col-cell filterbar-title"><?php echo JText::_('APP_EVENT_NEWS_SUBTITLE'); ?></div>
                        ...
                        <div class="media-body">
                            ...
                            <div class="group-news-meta">
                                <ul class="fd-reset-list">
                                    ...
                                    <li>
                                        <i class="fa fa-eye"></i> <?php echo JText::sprintf(FD::string()->computeNoun('APP_EVENT_NEWS_HITS', $article->hits), $article->hits); ?>
                                    </li>
                                    <?php } ?>
                                </ul>
                            </div>
