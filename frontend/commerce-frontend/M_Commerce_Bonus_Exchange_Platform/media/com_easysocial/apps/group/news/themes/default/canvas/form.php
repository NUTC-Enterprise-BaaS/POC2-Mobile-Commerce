	...
	<div class="es-content-wrap">
		<form action="<?php echo JRoute::_( 'index.php' );?>" method="post">
			<div class="app-news news-form app-group">
				<h3><?php echo JText::_( 'APP_GROUP_NEWS_CREATE_ANNOUNCEMENT' ); ?></h3>

				<hr />

				<div class="form-group">
					<input type="text" name="title" value="<?php echo $this->html( 'string.escape' , $news->title );?>" placeholder="<?php echo JText::_( 'APP_GROUP_NEWS_TITLE_PLACEHOLDER' , true );?>" class="form-control input-sm news-title" />

					<?php if( $params->get( 'allow_comments' , true ) ){ ?>
					<label for="comments" class="checkbox">
						<input type="checkbox" name="comments"<?php echo $news->comments ? ' checked="checked"' : '';?>/> <?php echo JText::_( 'APP_GROUP_NEWS_ALLOW_COMMENTS' ); ?>
					</label>
					<?php } ?>
				...
				<div class="form-actions">
					<a href="<?php echo $group->getPermalink();?>" class="pull-left btn btn-es-danger btn-large"><?php echo JText::_( 'COM_EASYSOCIAL_CANCEL_BUTTON' ); ?></a>
