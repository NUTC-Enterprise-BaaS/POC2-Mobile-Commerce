...
<script type="text/javascript">
	...
	var minimumBalence="<?php echo JText::sprintf('COM_SOCIALADS_AD_ALLOWED_BUDGET', $displayData->sa_params->get('min_pre_balance'), $displayData->sa_params->get('currency'));?>";
