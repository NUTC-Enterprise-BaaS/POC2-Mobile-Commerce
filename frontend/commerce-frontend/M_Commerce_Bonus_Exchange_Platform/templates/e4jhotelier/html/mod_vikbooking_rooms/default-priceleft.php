<?php
/**------------------------------------------------------------------------
 * mod_vikbooking_rooms - PRICELEFT View - VikBooking
 * ------------------------------------------------------------------------
...
<div class="vbmodroomscontainer wrap">
	...
	<div class="frame" id="cyclepages" style="overflow: hidden;">
		<ul class="vbmodrooms vbmodrooms-priceleft" style="-webkit-transform: translateZ(0px); width: 6840px;">
			<?php
				foreach($rooms as $c) {
			?>
			<li>
				<div class="vbmodroomsboxdiv">	
					...
					if(!empty($c['img'])) {
					?>
						<div class="vbmodrooms-wrapper-img">
						<?php
							if($totalpeople == 1) {
							?>
					        ...
					        <?php }
							?>								
							<a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$c['id'].'&Itemid='.$params->get('itemid')); ?>">
							<div class="vbmodrooms-div-img-mask"></div>
							<div class="vbmodrooms-div-img">								
					...
					?>
					<div class="vbinf">
						<div class="vbmodrooms-inner-left">
