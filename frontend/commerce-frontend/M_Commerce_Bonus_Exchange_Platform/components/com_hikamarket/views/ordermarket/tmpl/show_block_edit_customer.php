...
if(empty($this->ajax)) {
	echo $this->dropdownHelper->display(
		...
		array(
			'customer' => array(
				'name' => JText::_('HIKAM_CHANGE_CUSTOMER'),
				'link' => '#customer',
				'click' => 'return window.orderMgr.showSelectCustomer(this, true);'
			)
		),
		array('type' => '', 'right' => false, 'up' => false)
	);
?>
...
?>
	...
	<div style="float:right">
		<button onclick="return window.orderMgr.selectCustomer(this);" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/plus.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKAM_SELECT_CUSTOMER'); ;?></button>
	</div>
	<button onclick="return window.orderMgr.showSelectCustomer(this, false);" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
