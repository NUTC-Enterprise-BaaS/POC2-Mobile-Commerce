...
?>
	...
	<div style="float:right">
		<button onclick="return window.orderMgr.submitDetails(this, 'shipping');" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save2.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_OK'); ;?></button>
	</div>
	<button onclick="return window.orderMgr.showEditDetails(this, 'shipping', false);" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
