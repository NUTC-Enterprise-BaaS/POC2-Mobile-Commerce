...
if(empty($this->ajax)) {
	...
	if($address_edit) {
		$data = array_merge($data, array(
			'-',
			array(
				'name' => JText::_('HIKAM_EDIT_ADDRESS'),
		...
		if(hikamarket::acl('user/show/address')) {
			$data[] = array(
				'name' => JText::_('HIKAM_SELECT_ADDRESS'),
				'link' => '#select_'.$type.'_address',
	...
	echo $this->dropdownHelper->display(
		JText::_('HIKAM_MORE'),
		$data,
		array('type' => '', 'right' => true, 'up' => false)
	);
...
?>
		...
		<div style="float:right">
			<button onclick="return window.orderMgr.selectAddress('<?php echo $type; ?>');" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save2.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKAM_SELECT_ADDRESS'); ;?></button>
		</div>
		<button onclick="return window.orderMgr.hideSelectAddress('<?php echo $type; ?>');" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
...
<?php } ?>
		<div style="clear:both;margin-top:4px;"></div>
		<div style="float:right">
			<button onclick="return window.orderMgr.submitAddress('<?php echo $type; ?>');" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save2.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_OK'); ;?></button>
		</div>
		<button onclick="return window.orderMgr.refreshAddressBlock('<?php echo $type; ?>', 0);" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
		<div style="clear:both"></div>
	</div>
<?php
}
