...
<form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=managecompanymessages');?>" method="post" name="adminForm" id="adminForm">
    <table class="dir-table dir-panel-table" id="itemList">
        ...
        <tr>
            ...
            <th width="auto"><?php echo JText::_('LNG_NAME') ?></th>
            <th width="auto" class="hidden-xs hidden-phone"><?php echo JText::_('LNG_EMAIL') ?></th>
            <th width="auto" class="hidden-xs hidden-phone"><?php echo JText::_('LNG_COMPANY_NAME') ?></th>
            <th width="auto" class=""><?php echo JText::_('LNG_MESSAGE') ?></th>
            <th width="auto" class="hidden-xs hidden-phone"></th>
        </tr>
        </thead>
        <tfoot>
        <tr>
