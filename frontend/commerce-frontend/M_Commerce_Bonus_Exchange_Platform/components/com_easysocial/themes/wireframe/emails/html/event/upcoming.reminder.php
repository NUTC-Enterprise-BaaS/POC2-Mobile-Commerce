    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_HEADING', $eventCount); ?>
            </div>
            <div style="font-size:12px; color: #798796;font-weight:normal">
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_SUBHEADING', $siteName); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;font-size:12px;color:#888">
                ...
                <tr>
                    <td>
                        <p style="text-align:left;">
                            <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_DEAR', $recipientName ); ?>
                        </p>

                        <p style="text-align:left;">
                            <?php echo JText::_('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_CONTENT');?>
                        </p>

                        <?php echo $events; ?>

                        <p style="text-align:left;">
                            <?php echo JText::_('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_CONTENT2');?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <a style="
                ...
                " href="<?php echo $loginLink;?>"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_LOGIN_NOW' );?></a>
