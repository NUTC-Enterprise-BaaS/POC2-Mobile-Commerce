	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_('COM_EASYSOCIAL_EMAILS_GROUP_NEW_VIDEO'); ?>
			</div>
		</div>
	</td>
</tr>
...
<tr>
	<td style="text-align: center;font-size:12px;color:#888">
		...
		<p style="text-align:center;padding: 0 30px;">
			<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_GROUP_NEW_VIDEO_CONTENT' , '<a href="' . $userLink . '">' . $userName . '</a>' , '<a href="' . $groupLink . '">' . $groupName . '</a>' );?>
		</p>
					...
					<table style="margin: 0 auto 10px 20px; text-align:left;" align="">
						<tr>
							<td style="text-align: center;background-color:#f8f9fb;padding: 5px;">
								<h2>
									<a href="<?php echo $videoLink;?>" style="text-decoration: none;color:#798796;"><?php echo $videoTitle;?></a>
								</h2>
								<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_GROUP_NEW_VIDEO_BY' , '<a href="' . $userLink . '" style="text-decoration: none;color:#798796;">' . $userName . '</a>' ); ?>
							</td>
						</tr>
						<tr>
							<td>
								<p style="font-size: 11px;line-height: 18px;"><?php echo $videoDescription; ?></p>
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">
								<a href="<?php echo $videoLink;?>" style="
								...
								">
									<?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_VIDEO_BUTTON');?> &rarr;
								</a>
							</td>
						</tr>
					</table>
