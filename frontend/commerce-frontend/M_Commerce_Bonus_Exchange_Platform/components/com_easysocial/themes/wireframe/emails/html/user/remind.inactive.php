    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_INACTIVE_REMINDER_HEADING'); ?>
            </div>
            <div style="font-size:12px; color: #798796;font-weight:normal">
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_INACTIVE_REMINDER_SUBHEADING', $siteName); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;font-size:12px;color:#888">
            ...
            <table width="540" cellspacing="0" cellpadding="0" border="0" align="center" style="table-layout:fixed;margin:0 auto;">
                <tr>
                    <td>
                        ...
                        <p style="text-align:left;">
                            <?php echo JText::_('COM_EASYSOCIAL_EMAILS_INACTIVE_REMINDER_CONTENT');?>
                        </p>

                        <p style="text-align:left;">
                            <?php echo JText::_('COM_EASYSOCIAL_EMAILS_INACTIVE_REMINDER_CONTENT2');?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <a style="
                ...
                " href="<?php echo $loginLink;?>"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_LOGIN_NOW' );?></a>
