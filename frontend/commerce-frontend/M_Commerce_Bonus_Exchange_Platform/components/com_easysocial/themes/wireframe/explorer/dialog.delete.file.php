...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_EXPLORER_DELETE_FILE_DIALOG_TITLE' ); ?></title>
	<content>
		<p><?php echo JText::sprintf( 'COM_EASYSOCIAL_EXPLORER_DELETE_FILE_DIALOG_CONTENT' , $file->name ); ?></p>
	</content>
	<buttons>
