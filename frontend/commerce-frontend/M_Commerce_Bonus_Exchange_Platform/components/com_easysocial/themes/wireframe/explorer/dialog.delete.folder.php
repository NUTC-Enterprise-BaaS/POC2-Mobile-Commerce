...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_EXPLORER_DELETE_FOLDER_DIALOG_TITLE' ); ?></title>
	<content>
		<p><?php echo JText::sprintf( 'COM_EASYSOCIAL_EXPLORER_DELETE_FOLDER_DIALOG_CONTENT' , $folder->get( 'title' ) ); ?></p>
	</content>
	<buttons>
