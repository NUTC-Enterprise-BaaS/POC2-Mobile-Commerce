<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DIALOG_REQUEST_TO_ATTEND_EVENT_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DIALOG_REQUEST_TO_ATTEND_EVENT_CONTENT');?></p>
    </content>
    <buttons>
