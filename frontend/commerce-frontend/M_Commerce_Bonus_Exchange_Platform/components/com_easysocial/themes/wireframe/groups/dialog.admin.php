...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_DIALOG_ADD_ADMIN_TITLE' ); ?></title>
	<content>
		<p><?php echo JText::sprintf( 'COM_EASYSOCIAL_GROUPS_DIALOG_ADD_ADMIN_CONTENT' , $user->getName() , $user->getName() );?></p>
	</content>
	<buttons>
