...
?>
<div class="es-dashboard" data-filter-form>
	...
	<div class="es-container">
		...
		<div class="es-content" data-filter-content>

			<i class="loading-indicator fd-small"></i>

			<div data-filter-real-content>
				<?php echo $this->includeTemplate( 'site/stream/form.edit' ); ?>
			</div>
