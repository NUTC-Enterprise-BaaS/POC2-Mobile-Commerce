		...
		<div class="popbox-dropdown-menu dropdown-menu-login loginDropDown" style="display: block;">
			...
			<ul class="fd-reset-list">
				...
				<li>
					...
					<input type="submit" class="btn btn-es-success pull-right" name="Submit" value="<?php echo JText::_( 'COM_EASYSOCIAL_LOGIN_BUTTON' , true );?>" tabindex="105">
				</li>
			...
			<div class="dropdown-menu-footer">
				<ul class="fd-reset-list">
					...
					<li>
						<i class="fa fa-plus-2"></i>  <a href="<?php echo FRoute::registration();?>" class="pull-" tabindex="5"><?php echo JText::_( 'COM_EASYSOCIAL_REGISTRATION_CREATE_NEW_ACCOUNT' );?></a>
					</li>
					<?php } ?>
					<?php if( !$this->config->get( 'registrations.emailasusername' ) ) { ?>
					<li>
						<i class="fa fa-help"></i>  <a href="<?php echo FRoute::account( array( 'layout' => 'forgetUsername' ) );?>" class="pull-" tabindex="6"><?php echo JText::_( 'COM_EASYSOCIAL_REGISTRATION_FORGOT_USERNAME' );?></a>
					</li>
					<?php } ?>
					<li>
						<i class="fa fa-help"></i>  <a href="<?php echo FRoute::account( array( 'layout' => 'forgetPassword' ) );?>" class="pull-" tabindex="6"><?php echo JText::_( 'COM_EASYSOCIAL_REGISTRATION_FORGOT_PASSWORD' );?></a>
					</li>
				</ul>
			</div>
