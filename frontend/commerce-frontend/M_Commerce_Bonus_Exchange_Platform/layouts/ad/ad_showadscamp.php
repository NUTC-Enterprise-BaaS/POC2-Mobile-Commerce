			...
			<fieldset class="sa-fieldset">
				...
				<div class="container-fluid">
					...
					<div class="form-actions">
						<button id="buy" type="button" class="btn btn-default btn-success" onclick="submitbutton('create.activateAd')">
							<?php echo JText::_('COM_SOCIALADS_SAVE_ACTIVATE');?>
						</button>
						<button id="draft" type="button" class="btn btn-default btn-info" onclick="submitbutton('create.draftAd');">
