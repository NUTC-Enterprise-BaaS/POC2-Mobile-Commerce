			...
			<div class="paymentHTMLWrapper">
				...
				if (!$mainframe->isAdmin() && $termsAnsCondition == 1 && !empty($articleTerms))
				{
					...
					<div class="form-group">
						...
						?>
							<a href="<?php echo JUri::root().'index.php?option=com_content&tmpl=component&view=article&id=' . $articleTerms ; ?>" class="" target="_blank">
				...
				{ ?>
					<div class="" id="sa_paymentlistWrapper" style="<?php echo $paymentListStyle; ?>">
						<div class="form-group " id="sa_paymentGatewayList">
							<?php
							$default = "";
							$label   = JText::_('COM_SOCIALADS_AD_SEL_GATEWAY');
							$gateway_div_style = 1;
							...
							<div class="col-md-8 col-sm-7 col-xs-12" style="<?php echo ($gateway_div_style==1)?"" : "display:none;" ?>">
								...
								else
								{
									...
									$ad_fun = "onchange=\"sa.create.getPaymentGatewayHtml(this.value," . $displayData->order_id . ",'" . trim($paymentMode) . "', '" . JText::_('COM_SOCIALADS_PAYMENT_GATEWAY_LOADING_MSG') . "', '" . $imgpath . "');\"";

									foreach ($this->ad_gateways as $gateway)
									{ ?>
										<div class="radio">
										  <label>
						...
						<form method="post" name="sa_freePlaceOrder" class="" id="sa_freePlaceOrder">
							<div class="techjoomla-bootstrap" >
								...
								<div class="form-actions">
									<input type="submit" class="btn btn-default btn-success btn-lg" value="<?php echo JText::_('COM_SOCIALADS_AD_CONFORM_ORDER'); ?>">
								</div>
							</div>
						</form>
					</div>
