...
$slabEnable = $displayData->sa_params->get('slab_enable');
			...
			<div class="container-fluid">
				...
				if ($displayData->special_access)
				{
					...
					<div class="form-group">
						...
						<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-6" for="type" title="">
							<?php echo JText::_('COM_SOCIALADS_AD_UNLIMITED_AD'); ?>
						</label>

						<div id="review" class="col-lg-9 col-md-9 col-sm-8 col-xs-6 unlimited_yes_no">
				...
				<div class="form-group">
					...
					if ($showimpclick == 0)
					{ ?>
						<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12">
				...
				<div class="form-group" id="priceperdate" style="<?php echo $display_style; ?>">
					<?php
					if ($ad_daterangefrom && isset($ad_daterangefrom))
					{
						...
						<div class="ad-price-lable col-lg-9 col-md-9 col-sm-12 col-xs-12">
					...
					else
					{
						...
						if ($recurringPayments)
							$re_chked = 'checked="checked"';
										//echo "=====2=====";
						?>
							<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-6" width="40%">
								<?php echo JHtml::tooltip(JText::_('COM_SOCIALADS_AD_CHARGE_PER_DAY_FROM_DESC'), JText::_('COM_SOCIALADS_AD_CHARGE_PER_DAY_FROM'), '', '* ' . JText::_('COM_SOCIALADS_AD_CHARGE_PER_DAY_FROM')); ?>
							</label>
							<div class="ad-price-lable col-lg-9 col-md-9 col-sm-6 col-xs-6">
				...
				<div class="form-group" id="total_days" style="<?php echo $date_dis; ?>">
					<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12" id="total_days_label" width="40%">
				...
				{ ?>
					<div id="priceperclick" class = "form-group" style="display:none">
				<?php
				}
				else
				{ ?>
					<div id="priceperclick" class = "form-group" style="display:block">
				<?php
				} ?>
						<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12">
				...
				<div class = "form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 cal_text">
				...
				<div class="form-group" style="display:none">
					<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12"><?php echo $gatewaylabel; ?></label>
					<?php
					if ($payment_flag)
					{ ?>
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				<div class="sa_hideForUnlimitedads" >
					<div class="form-group " >
						...
						<div class="form-group" >
							<div id="sa_cop_tr"  style="display:none;" class="col-sm-offset-3 col-sm-9 form-inline">
								...
								<input type="button" class="btn btn-default btn-success" onclick="sa.create.applyCoupon(1)"
									value="<?php echo JText::_("COM_SOCIALADS_AD_COUPON_APPLY") ?>">
							</div>
						</div>

					<div class="form-group sa_cop_details " style="display:none;" >
						<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12"><?php echo JText::_("COM_SOCIALADS_COUPON_PRICE") ?></label>
							<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" id="sa_cop_afterprice">
							</div>
					</div>

					<div class="form-group sa_cop_details " style="display:none;" >
						<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12"> <?php echo JText::_("COM_SOCIALADS_AFTER_COUPON_PRICE") ?></label>
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" id="sa_cop_price">
						</div>
					</div>
				</div>
			</div>
