	...
	<div id="geo_target_space" class="target_space well">
		<div class="form-group">
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6 input-group targetting_yes_no">
				...
				<label label-default class="first btn btn-default <?php echo $publish1_label;?>" type="button" for="publish1">
					<?php echo JText::_('JYES');?>
				</label>
				<input type="radio" name="geo_targett" id="publish2" value="0" <?php echo $publish2;?> >
				<label label-default class="last btn btn-default <?php echo $publish2_label;?>" type="button" for="publish2">
		...
		<div id="geo_targett_div" <?php echo $geo_dis; ?> class="targetting">
			...
			if ($displayData->geodbfile_exists)
			{
				...
				<div id="mapping-field-table">
					<div class="form-group">
						<label label-default for="" title="<?php echo JText::_('COM_SOCIALADS_AD_GEO_COUNTRY');?>">
					...
					<div class="form-group">
						<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
							<div id ="geo_others" style="display:none;">
								<label label-default class="saradiolabel label-default radio" for="everywhere"><input type="radio"
								...
								<div <?php echo in_array('byregion', $displayData->sa_params->get('geo_options')) ? '' :'style="display:none;"'; ?> >
									<label label-default class="saradiolabel label-default radio" for="byregion">
										<input type="radio"
								...
								<div <?php echo in_array('bycity', $displayData->sa_params->get('geo_options')) ? '' : 'style="display:none;"'; ?>>
									<label label-default class="saradiolabel label-default radio" for="bycity">
										<input type="radio"
