...
<div class="business-categories-slider-wrapper<?php echo $moduleclass_sfx; ?>" >
    <div class="business-categories-slider responsive slider">
...
<script>
	jQuery(document).ready(function(){
		jQuery('.business-categories-slider').slick({
			dots: false,
