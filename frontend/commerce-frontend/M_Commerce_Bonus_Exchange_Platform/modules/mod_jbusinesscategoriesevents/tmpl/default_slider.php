...
<div class="event-categories-slider-wrapper<?php echo $moduleclass_sfx; ?>" >
    <div class="event-categories-slider responsive slider">
...
<script>
    jQuery(document).ready(function(){
        jQuery('.event-categories-slider').slick({
            dots: false,
