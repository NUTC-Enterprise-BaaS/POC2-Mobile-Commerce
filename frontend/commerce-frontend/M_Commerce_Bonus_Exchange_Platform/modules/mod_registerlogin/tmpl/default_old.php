...
<div class="registration_" id="registration_" style="<?php echo (isset($view ) && $view  == 2) ? 'display : block' : 'display : none' ?>">
	<form action="" method="post" id="registration_form" name="josForm" class="form-validate form-horizontal">
			...
			<?php if ($params->get('usetext')) : ?>
				<div style="padding-top: 30px;">
					<span class="text"><label id="recommend" for="recommend"><?php echo JText::_('推薦人'); ?></label></span>
				</div>
			<?php endif; ?>
			<div>
				<div class="input-prepend">
			...
			<div class="control-group">
				<?php if ($params->get('usetext')) { ?>
					<div>
						<span class="text"><label id="phone" for="phone"><?php echo JText::_('電話'); ?>*</label></span>
					</div>
				<?php } ?>
				<div>
				<div class="input-prepend">
				<span class="add-on">
					...
					<input tabindex="2" type="text" placeholder="<?php echo JText::_('請輸入想要的電話號碼'); ?>" id="jform_phone" name="jform[phone]" size="20" value="<?php echo (isset($_REQUEST['jform']['phone']) && !empty($_REQUEST['jform']['phone'])) ? $_REQUEST['jform']['phone'] : ''; ?>" class="inputbox validate-phone required"  />
				</div>
				</div>
			</div>
			<!--  -->
