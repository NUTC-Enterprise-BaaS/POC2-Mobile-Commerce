 ...
 *
 */
class JBusinessDirectoryModelPoint extends JModelAdmin
{
    /**
     * @var     string  The prefix to use with controller messages.
     * @since   1.6
     */
    protected $text_prefix = 'COM_JBUSINESSDIRECTORY_POINT';
     ...
     * @var     string
     */
    protected $_context     = 'com_jbusinessdirectory.point';
