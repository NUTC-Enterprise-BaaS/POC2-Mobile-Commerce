...
class JBusinessDirectoryViewSpepoint extends JBusinessDirectoryAdminView
{
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_($isNew ? '特約店家 發送點數記錄' : '特約店家發點紀錄'), 'menu.png');

		JToolbarHelper::cancel('spepoint.cancel', 'JTOOLBAR_CLOSE');
