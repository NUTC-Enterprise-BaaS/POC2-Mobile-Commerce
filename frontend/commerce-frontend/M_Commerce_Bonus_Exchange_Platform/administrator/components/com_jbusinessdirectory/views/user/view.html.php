...
class JBusinessDirectoryViewUser extends JBusinessDirectoryAdminView
{
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_($isNew ? '新增會員資料' : '編輯會員資料'), 'menu.png');
		...
		JToolbarHelper::help('JHELP_JBUSINESSDIRECTORY_USER_EDIT');
	}
