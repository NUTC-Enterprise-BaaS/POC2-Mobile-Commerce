...
class JBusinessDirectoryViewPrepoint extends JBusinessDirectoryAdminView
{
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_($isNew ? '優惠店家 收取點數記錄' : '優惠店家收取紀錄'), 'menu.png');

		JToolbarHelper::cancel('prepoint.cancel', 'JTOOLBAR_CLOSE');
