...
class configmarketViewconfigmarket extends hikamarketView {
	...
	public function config($tpl = null) {
		hikamarket::setTitle(JText::_(self::name), HIKASHOP_J30 ? self::j3icon : self::icon, self::ctrl);
	...
	public function sql($tpl = null) {
		hikamarket::setTitle(JText::_('HIKA_CONFIGURATION_SQL'), HIKASHOP_J30 ? self::j3icon : self::icon, self::ctrl);
