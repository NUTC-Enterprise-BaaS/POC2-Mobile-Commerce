...
class TjfieldsTablegroup extends JTable {
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_tjfields.group.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_tjfields','group');
            $default_actions = JFactory::getACL()->getAssetRules('com_tjfields.group.'.$array['id'])->getData();
            $array_jaccess = array();
