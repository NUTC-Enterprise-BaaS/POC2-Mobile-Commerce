...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CATEGORIES_DELETE_CONFIRMATION_TITLE'); ?></title>
	<content>
		<p><?php echo JText::_('COM_EASYSOCIAL_VIDEOS_CATEGORIES_DELETE_CONFIRMATION_CONTENT'); ?></p>
	</content>
	<buttons>
