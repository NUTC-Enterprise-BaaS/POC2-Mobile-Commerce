...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DELETE_EVENT_DIALOG_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DELETE_EVENT_DIALOG_CONFIRMATION'); ?></p>
    </content>
    <buttons>
