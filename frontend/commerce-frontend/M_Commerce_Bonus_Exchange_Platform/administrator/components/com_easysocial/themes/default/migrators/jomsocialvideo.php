	...
	<div class="col-md-6">
		<div class="panel" data-start-widget>
			...
			<div class="panel-head">
				<ol>
					<li>
						<?php echo JText::_( 'COM_EASYSOCIAL_MIGRATOR_JOMSOCIAL_USER_VIDEOS_ITEM' );?>
					</li>
					<li>
						<?php echo JText::_( 'COM_EASYSOCIAL_MIGRATOR_JOMSOCIAL_GROUP_VIDEOS_ITEM' );?>
					</li>
				</ol>
				...
				<?php if( $installed ){ ?>
					...
					<?php } else if (!$isLocalFiles) { ?>
						<div class="text-error">
							<strong><?php echo JText::_('COM_EASYSOCIAL_MIGRATOR_JOMSOCIAL_VIDEO_AMAZON_NOT_SUPPORTED'); ?></strong>
						</div>
					<?php } else { ?>
...
<div class="row">
	<div class="col-md-6">
		...
		<a href="<?php echo JRoute::_( 'index.php?option=com_easysocial&view=migrators&layout=jomsocialvideo' ); ?>" style="display: none;" data-jomsocial-back-button >
			<?php echo JText::_( 'COM_EASYSOCIAL_MIGRATOR_BACK_TO_JOMSOCIAL_VIDEO_PAGE' );?>
		</a>
	</div>
</div>
