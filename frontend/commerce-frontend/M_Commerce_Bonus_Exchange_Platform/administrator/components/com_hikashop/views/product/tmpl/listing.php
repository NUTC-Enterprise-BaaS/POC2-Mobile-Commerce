...
?>
						<tr class="row<?php echo $k; ?>">
							...
							<td><?php
								...
								if (is_null($row->prices['0_all_111']->price_value_with_discount) || $row->prices['0_all_111']->price_value_with_discount == 0) {
								} else {
									echo  '<br/>'. $row->prices['0_all_111']->price_value_with_discount . '折';
								}
							?></td>
							<td><?php
