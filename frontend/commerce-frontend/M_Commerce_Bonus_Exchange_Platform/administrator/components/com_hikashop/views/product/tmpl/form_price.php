...
$acls = array(
	...
	'discount' => hikashop_acl('product/edit/price/discount'),
...
<?php }
	if($acls['discount']){ ?>
			<td class="hika_price">
				<?php echo $pre_price; ?><input size="10" type="text" id="hikashop_<?php echo $form_key; ?>_<?php echo $i;?>_with_discount" name="<?php echo $form_key; ?>_with_discount_<?php echo $i;?>" value="<?php echo @$price->price_value_with_discount; ?>" onchange="window.productMgr.updatePrice(<?php echo $i; ?>, false, '<?php echo $form_key; ?>')"/><?php echo $post_price; ?>
			</td>
<?php }
	if($acls['currency']){ ?>
