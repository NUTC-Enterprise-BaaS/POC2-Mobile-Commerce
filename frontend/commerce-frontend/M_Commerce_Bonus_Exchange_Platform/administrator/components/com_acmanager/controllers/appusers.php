...
/**
 * Appusers list controller class.
 *
 * @since  1.6
 */
class AcmanagerControllerAppusers extends JControllerAdmin
{
	/**
	 * Method to clone existing Appusers
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'appuser', $prefix = 'AcmanagerModel', $config = array())
	{
