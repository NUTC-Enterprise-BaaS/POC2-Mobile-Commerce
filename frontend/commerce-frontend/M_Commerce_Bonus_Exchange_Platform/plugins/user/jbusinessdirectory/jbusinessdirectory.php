 ...
 * @since  1.6
 */
class plgUserjbusinessdirectory extends JPlugin
{
	/**
	...
	public function onUserAfterSave($user, $isnew, $success, $msg)
	{
		...
		if ($contact = $this->getContactTable())
		{
			 ...
			 */
			if (!$contact->load(array('id' => (int) $id)))
			{
	...
	{
		JTable::addIncludePath(JPATH_ADMINISTRATOR . '/components/com_jbusinessdirectory/tables');

		return JTable::getInstance('userjbusiness');
	}
}
